const chs = {
  ...
  "docSuffix": "_chs",
  "copyright": {
    "line": "版权所有 © 2020&ndash;2025 Log Creative",
    ...
    "glm4": "GLM 4.6 由智谱 AI 版权所有，遵循 <a href='https://github.com/zai-org/GLM-4.5/blob/main/LICENSE' target='_blank'>Apache 2.0 协议</a>。",
    "ai-limitation": "不保证大模型生成的代码、程序及其指向的内容的准确性、稳定性和完整性，请仔细甄别。",
    "privacy": "<p>隐私政策：为了编译 TeX 文档以及提供更好的用户体验，您必要的代码信息将会通过匿名、临时的方式被本网站或第三方网站 <a href='https://latexonline.cc/' target='_blank'>LaTeX Online</a> 收集。这些数据将会以容器化与除本网站外无外部连接的方式存储，并会被定期删除。您可以在 <a href='https://github.com/LogCreative/PGFPlotsEdt' target='_blank'>GitHub 存储库</a>中检查源代码。如果不使用快速编译的方框没有被勾选，表明您同意这一政策。</p>",
